// 
/**
 ...
 **
 ** BROWSERJS_TIMESTAMP = '201908141400'; // for versioning; see DNA-54964
 **/
  ...
  (function(document) {
    ...
    */
    ...
    const version = () => {
      ...
      return `Opera OPRDesktop 28.0 core 1750.0, August 14, 2019. Active patches: ${total}`;
    ...
    const PATCHES = {
      ...
      'DNA-79079': {
        description: 'Mock as Chrome on mamaearth',
        isMatching: () => isPartOfDomain('mamaearth.ca'),
        apply: () => hideOperaUserAgent(),
      },
      'DNA-79341': {
